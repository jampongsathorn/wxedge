...
**รอบการทำงาน (v4):**
- ทุก 10 นาที → `deploy/gate.py` เลือกเมืองตาม 2 ช่วงเวลา: **entry 15:30–16:30 local ทุก 10 นาที** (7 ตัวอย่าง/เมือง/วัน รอบ 16:00) และ **ctx 14:00–18:00 ทุก 30 นาที**
...
- ⚠️ ต้องเป็น **repo สาธารณะ**: GitHub ปัดนาที CI ขึ้นเป็นนาทีต่อรอบ → 144 รอบ/วัน ≈ 4,400 นาที/เดือน เกินโควตาฟรี 2,000 ของ repo ส่วนตัว
